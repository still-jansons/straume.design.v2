...
<template>
    ...
    <div class="min-h-full sm:h-screen sm:overflow-hidden pt-[120px] sm:pt-[140px] sm:pb-[90px] sm:flex flex-col bg-secondary">
        <div @wheel="onImageScroll" ref="image_container" class="grid sm:flex grid-flow-col overflow-x-auto hide-scroll sm:flex-1 gap-[15px] px-[30px] sm:px-10">
        ...
        <div class="sm:h-[60%]">
            ...
            ">
                ...
                <div class="flex pt-5 sm:pt-2.5 mt-2.5 pb-5 border-t border-primary justify-end">
                    <NuxtLink v-if="next && next._path.includes('/stories/')" :to="next._path.replace('/en', '')" class="group text-base 2xl:text-xl font-medium text-ellipsis overflow-hidden">
                        {{ next.title }}
